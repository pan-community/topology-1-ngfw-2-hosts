...
output "untrust_subnet_cidr" {
  value = azurerm_subnet.untrust.attributes.address_prefix
}

output "trust_subnet_cidr" {
  value = azurerm_subnet.trust.attributes.address_prefix
}

output "dmz_subnet_cidr" {
  value = azurerm_subnet.dmz.attributes.address_prefix
}
